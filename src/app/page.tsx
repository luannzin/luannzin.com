...
export default function Home() {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center">
      <div className="w-full h-20 border-b border-border flex items-center justify-center">
        <div className="h-full max-w-[1920px] w-full border-x border-border"></div>
      </div>
      <div className="h-full max-w-[1920px] w-full border-x border-border">
        <div className="w-full h-full flex items-center justify-center">
          <div className="flex flex-col gap-4">
            <Logo />
            <div className="flex flex-col gap-0">
              <span>I'm Luan Fabri,</span>
            ...
            <Link
              href="/about"
              className={cn("group text-primary block w-fit")}
            >
      ...
      <div className="w-full h-20 border-t border-border flex items-center justify-center">
        <div className="h-full max-w-[1920px] w-full border-x border-border"></div>
      </div>
    </div>
  );
